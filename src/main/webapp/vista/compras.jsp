...
<html>
    <head>
        ...
        <!-- Enlaces a Bootstrap y FontAwesome para el diseño y los íconos -->
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <ul class="navbar-nav btn-group my-2 my-lg-0" role="group">
                    <!-- Opciones de usuario en un menú desplegable -->
                    <a style="color: white; cursor: pointer" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fas fa-user-tie"></i> ${logueo}</a>
                    <div class="dropdown-menu text-center dropdown-menu-right">
                        <!-- Imagen de usuario, nombre de usuario, correo y opciones -->
        ...
        <div class="container mt-4">
            ...
            <div class="row">   
                ...
                <table class="table tab-pane">
                    ...
                    <tbody>
                        <!-- Iteración sobre las compras para mostrar los detalles -->
                            <tr class="text-center">
                                <td>C00${p.getId()}</td>                                  
                                <td>${p.getFecha()}</td>
                                <td>${p.getMonto()}</td>                                                                                                       
                                ...
                                <td>${p.getEstado()}</td>                                                                                                       
                                <td>
                                    <!-- Enlace para ver los detalles de la compra -->
