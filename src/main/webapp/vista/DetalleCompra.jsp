                    ...
                    <table class="table tab-pane">
                        ...
                        <tbody>
                            <!-- Itera sobre los detalles de la compra -->
                                <tr class="text-center">
                                    <td>C00${p.getIdcompra()}</td> <!-- Código de la compra -->
                                    <td>                                        
                                        <label><i>${p.producto.nombres}</i></label><br> <!-- Nombre del producto -->                                     
                                        <img src="${p.producto.imagen}" width="80" height="60"> <!-- Imagen del producto -->
                                    </td>                                                                
                                    <td>${p.getCantidad()}</td> <!-- Cantidad del producto -->
                                    <td>${p.getPrecioCompra()}</td> <!-- Precio de compra del producto -->                                                                                                     
